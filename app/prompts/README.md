...
| `agent_final_answer.txt` | Final Answer / 最终回答模型 | `app.agent_runtime.runner.AgentRunner` | 服务端完成受控工具链且证据齐全后，只组织最终中文回答 |
...
2. 当前 Agent Runtime 文件统一以 `agent_planner_`、`agent_final_answer_` 或 `agent_replanner` 开头。
