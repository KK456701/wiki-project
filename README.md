...
- `ollama_base_url`；使用 DeepSeek 时在进程环境设置 `DEEPSEEK_API_KEY`。
...
- 前后端接口对接：[`docs/wiki-project_后端接口对接文档_2026-07-22.docx`](docs/wiki-project_后端接口对接文档_2026-07-22.docx)（覆盖 65 个业务 API、SSE 事件、鉴权、错误码与联调清单）
