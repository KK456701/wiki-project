...
tt."分子-四级手术并发症发生率",
tt."分母-三级手术并发症发生率",
CONCAT(tt."分子-四级手术并发症发生率", ' : ', tt."分母-三级手术并发症发生率") as 监测情况,
CASE
WHEN tt.third_grade_rate = 0 THEN NULL
...
CASE WHEN a.四级手术患者数 = 0 THEN 0 ELSE 1.0 * a.四级手术并发症患者数 / a.四级手术患者数 END AS fourth_grade_rate,
CASE WHEN b.三级手术患者数 = 0 THEN 0 ELSE 1.0 * b.三级手术并发症患者数 / b.三级手术患者数 END AS third_grade_rate
 from (
SELECT
