---
title: "衍生指标实体 - HXZD-009-002_001_医务部门组织讨论的死亡病例与发生纠纷的死亡病例比值"
created: 2026-07-29
updated: 2026-07-29
type: entity
tags: ["HXZD-009-002_001", "死亡病例讨论制度", "CORE_DEATH", "逻辑判定类"]
sources: [raw/excel/AI指标顾问【AI Metrics Advisor】7.xls]
confidence: high
---

# HXZD-009-002_001 — 医务部门组织讨论的死亡病例与发生纠纷的死亡病例比值

> **指标概念：** [[concepts/HXZD-009-002医务部门组织讨论的死亡病例与发生纠纷的死亡病例比值]] | **制度：** 死亡病例讨论制度 | **事件编码：** CORE_DEATH
> **版本：** 公版 | **指标导向：** 逐步提高
...
| 目标值 | 无 |
| 异常范围初筛 | 0.0 |
| 方案类型 | 推荐方案（纠纷数据来源：医务管理系统（需上线医务系统投诉纠纷管理功能）） |
| 配置类型 |  |
| 配置值 |  |
...
-- 分母口径：仅统计同期发生医疗纠纷的死亡病例（MEDICAL_DISPUTE_CASE=98175）
AND event.MEDICAL_DISPUTE_CASE = '98175'
...
and event.IS_DEL = 0
    AND event.ADMITTED_TO_WARD_AT BETWEEN :marptBeginAt and :marptEndAt
-- 分母口径：仅展示同期发生医疗纠纷的死亡病例明细（MEDICAL_DISPUTE_CASE=98175）
AND event.MEDICAL_DISPUTE_CASE = '98175'
#ETC{AND event.CURRENT_DEPT_ID IN (:deptIdIn)}
#ETC{ AND event.HOSPITAL_AREA_ID IN (:hospitalAreaList) }
#EQUALS{:status; 98175; AND MEDICAL_DEPT_ORGANIZED = '98175' ; }
#EQUALS{:status; 98176; AND MEDICAL_DEPT_ORGANIZED = '98176' ; }
```
...
- 血缘解析：[[entities/HXZD-009-002_001_医务部门组织讨论的死亡病例与发生纠纷的死亡病例比值_血缘说明.md]]
...
<!-- entity: HXZD-009-002_001 | code: HXZD-009-002 | system: 死亡病例讨论制度 | dim: 逻辑判定类 -->