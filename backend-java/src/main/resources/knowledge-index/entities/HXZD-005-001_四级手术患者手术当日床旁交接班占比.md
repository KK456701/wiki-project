...
updated: 2026-07-29
type: entity
tags: ["HXZD-005-001", "值班和交接班制度", "CORE_SHIFTHANDOVER", "逻辑判定类"]
...
> **指标概念：** [[concepts/HXZD-005-001四级手术患者手术当日床旁交接班占比]] | **制度：** 值班和交接班制度 | **事件编码：** CORE_SHIFTHANDOVER
> **版本：** 公版 | **指标导向：** 逐步提高
...
- 指标概念：[[concepts/HXZD-005-001四级手术患者手术当日床旁交接班占比]]
- 血缘解析：[[entities/HXZD-005-001_四级手术患者手术当日床旁交接班占比_血缘说明.md]]
...
<!-- entity: HXZD-005-001 | code: HXZD-005-001 | system: 值班和交接班制度 | dim: 逻辑判定类 -->