---
title: "衍生指标实体 - HXZD-003-003_001_普通会诊及时完成率"
created: 2026-07-29
updated: 2026-07-29
type: entity
tags: ["HXZD-003-003_001", "会诊制度", "CORE_CONSUL", "时限类"]
sources: [raw/excel/AI指标顾问【AI Metrics Advisor】7.xls]
confidence: high
---

# HXZD-003-003_001 — 普通会诊及时完成率

> **指标概念：** [[concepts/HXZD-003-003普通会诊及时完成率]] | **制度：** 会诊制度 | **事件编码：** CORE_CONSUL
> **版本：** 公版 | **指标导向：** 逐步提高
...
WHERE
 ...
 #ETC{ AND event.HOSPITAL_AREA_ID IN (:hospitalAreaList) }
  ...
  #EQUALS{:status; 98175; AND REGULAR_CONSULT_TIMELY = '98175' ; }
 #EQUALS{:status; 98176; AND REGULAR_CONSULT_TIMELY = '98176' ; }'"
```
...
- 指标概念：[[concepts/HXZD-003-003普通会诊及时完成率]]
- 血缘解析：[[entities/HXZD-003-003_001_普通会诊及时完成率_血缘说明.md]]
...
<!-- entity: HXZD-003-003_001 | code: HXZD-003-003 | system: 会诊制度 | dim: 时限类 -->