---
title: "衍生指标实体 - HXZD-015-001_001_特殊使用级抗菌药物使用会诊率"
created: 2026-07-29
updated: 2026-07-29
type: entity
tags: ["HXZD-015-001_001", "抗菌药物分级管理制度", "CORE_SPECIAL_ANTI", "逻辑判定类"]
sources: [raw/excel/AI指标顾问【AI Metrics Advisor】7.xls]
confidence: high
---

# HXZD-015-001_001 — 特殊使用级抗菌药物使用会诊率

> **指标概念：** [[concepts/HXZD-015-001特殊使用级抗菌药物使用会诊率]] | **制度：** 抗菌药物分级管理制度 | **事件编码：** CORE_SPECIAL_ANTI
> **版本：** 公版 | **指标导向：** 逐步提高
...
SELECT
    ...
    CASE WHEN r.MRAS_WF_APPREGISTER_ID IS NOT NULL 
     ...
     ELSE N''                          -- SQL Server 的 NVARCHAR 空字符串
...
- 血缘解析：[[entities/HXZD-015-001_001_特殊使用级抗菌药物使用会诊率_血缘说明.md]]
...
<!-- entity: HXZD-015-001_001 | code: HXZD-015-001 | system: 抗菌药物分级管理制度 | dim: 逻辑判定类 -->