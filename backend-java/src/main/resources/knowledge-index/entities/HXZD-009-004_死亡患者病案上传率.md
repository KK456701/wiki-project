---
title: "衍生指标实体 - HXZD-009-004_死亡患者病案上传率"
created: 2026-07-29
updated: 2026-07-29
type: entity
tags: ["HXZD-009-004", "死亡病例讨论制度", "CORE_DEATH", "内容完整性"]
...
> **指标概念：** [[concepts/HXZD-009-004死亡患者病案上传率]] | **制度：** 死亡病例讨论制度 | **事件编码：** CORE_DEATH
> **版本：** 公版 | **指标导向：** 逐步提高
...
#ETC{ AND event.HOSPITAL_AREA_ID IN (:hospitalAreaList) }
#ETC{AND event.CURRENT_DEPT_ID IN (:deptIdIn)}
#EQUALS{:status; 98175; AND REQUIRED_UPLOAD_RECORD = '98175' ; }
#EQUALS{:status; 98176; AND REQUIRED_UPLOAD_RECORD = '98176' ; }
```
...
- 指标概念：[[concepts/HXZD-009-004死亡患者病案上传率]]
- 血缘解析：[[entities/HXZD-009-004_死亡患者病案上传率_血缘说明.md]]
...
<!-- entity: HXZD-009-004 | code: HXZD-009-004 | system: 死亡病例讨论制度 | dim: 内容完整性 -->