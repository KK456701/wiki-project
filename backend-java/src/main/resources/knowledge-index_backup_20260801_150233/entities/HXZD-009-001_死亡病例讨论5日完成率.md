---
title: "衍生指标实体 - HXZD-009-001_死亡病例讨论5日完成率"
created: 2026-07-29
updated: 2026-07-29
type: entity
tags: ["HXZD-009-001", "死亡病例讨论制度", "CORE_DEATH", "时限类"]
sources: [raw/excel/AI指标顾问【AI Metrics Advisor】7.xls]
confidence: high
---

# HXZD-009-001 — 死亡病例讨论5日完成率

> **指标概念：** [[concepts/HXZD-009-001死亡病例讨论5日完成率]] | **制度：** 死亡病例讨论制度 | **事件编码：** CORE_DEATH
> **版本：** 公版 | **指标导向：** 逐步提高
...
#ETC{AND event.CURRENT_DEPT_ID IN (:deptIdIn)}
#ETC{ AND event.HOSPITAL_AREA_ID IN (:hospitalAreaList) }
#EQUALS{:status; 98175; AND DEATH_DISCUSSED_IN_DAYS = '98175' ; }
#EQUALS{:status; 98176; AND DEATH_DISCUSSED_IN_DAYS = '98176' ; }
```
...
- 指标概念：[[concepts/HXZD-009-001死亡病例讨论5日完成率]]
- 血缘解析：[[entities/HXZD-009-001_死亡病例讨论5日完成率_血缘说明.md]]
...
<!-- entity: HXZD-009-001 | code: HXZD-009-001 | system: 死亡病例讨论制度 | dim: 时限类 -->