---
title: "衍生指标实体 - HXZD-002-003_住院患者非计划手术率"
created: 2026-07-29
updated: 2026-07-29
type: entity
tags: ["HXZD-002-003", "三级查房制度", "CORE_WARDROUND", "逻辑判定类"]
...
> **指标概念：** [[concepts/HXZD-002-003住院患者非计划手术率]] | **制度：** 三级查房制度 | **事件编码：** CORE_WARDROUND
> **版本：** 公版 | **指标导向：** 逐步降低
...
WHERE
 ...
 #EQUALS{:onlySearchFeilds; ONLY_SEARCH_FEILDS;  1 = 0 ; 1=1}
    AND event.ADMITTED_TO_WARD_AT BETWEEN :marptBeginAt and :marptEndAt
 #ETC{AND event.CURRENT_DEPT_ID IN (:deptIdIn)}
 #EQUALS{:status; 98175; AND UNPLANNED_SURGERY = '98175' ; }
 #EQUALS{:status; 98176; AND UNPLANNED_SURGERY = '98176' ; }'"
```
...
- 指标概念：[[concepts/HXZD-002-003住院患者非计划手术率]]
- 血缘解析：[[entities/HXZD-002-003_住院患者非计划手术率_血缘说明.md]]
...
<!-- entity: HXZD-002-003 | code: HXZD-002-003 | system: 三级查房制度 | dim: 逻辑判定类 -->