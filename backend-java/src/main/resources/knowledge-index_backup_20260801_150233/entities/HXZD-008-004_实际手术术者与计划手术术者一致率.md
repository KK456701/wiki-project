---
title: "衍生指标实体 - HXZD-008-004_实际手术术者与计划手术术者一致率"
created: 2026-07-29
updated: 2026-07-29
type: entity
tags: ["HXZD-008-004", "术前讨论制度", "CORE_OP_DISC", "逻辑判定类"]
...
> **指标概念：** [[concepts/HXZD-008-004实际手术术者与计划手术术者一致率]] | **制度：** 术前讨论制度 | **事件编码：** CORE_OP_DISC
> **版本：** 公版 | **指标导向：** 逐步提高
...
#ETC{AND event.CURRENT_DEPT_ID IN (:deptIdIn)}
#ETC{ AND event.HOSPITAL_AREA_ID IN (:hospitalAreaList) }
#ETC{AND event.SURGEON_CONSISTENT = :isConsistent}
```
...
- 指标概念：[[concepts/HXZD-008-004实际手术术者与计划手术术者一致率]]
- 血缘解析：[[entities/HXZD-008-004_实际手术术者与计划手术术者一致率_血缘说明.md]]
...
<!-- entity: HXZD-008-004 | code: HXZD-008-004 | system: 术前讨论制度 | dim: 逻辑判定类 -->