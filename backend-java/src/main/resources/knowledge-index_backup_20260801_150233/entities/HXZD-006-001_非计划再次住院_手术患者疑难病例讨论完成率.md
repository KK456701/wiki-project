---
title: "衍生指标实体 - HXZD-006-001_非计划再次住院_手术患者疑难病例讨论完成率"
created: 2026-07-29
updated: 2026-07-29
type: entity
tags: ["HXZD-006-001", "疑难病例讨论制度", "CORE_DIFFI_EMR", "逻辑判定类"]
sources: [raw/excel/AI指标顾问【AI Metrics Advisor】7.xls]
confidence: high
---

# HXZD-006-001 — 非计划再次住院/手术患者疑难病例讨论完成率

> **指标概念：** [[concepts/HXZD-006-001非计划再次住院_手术患者疑难病例讨论完成率]] | **制度：** 疑难病例讨论制度 | **事件编码：** CORE_DIFFI_EMR
> **版本：** 公版 | **指标导向：** 逐步提高
...
#ETC{AND t1.FULL_NAME NOT LIKE :exPatientSet}
 #EQUALS{:syncType; increment; AND (t1.MODIFIED_AT BETWEEN :startTime AND :endTime OR t5.MODIFIED_AT BETWEEN :startTime AND :endTime OR t6.MODIFIED_AT BETWEEN :startTime and :endTime )}
...
WHERE
 ...
 #ETC{AND event.CURRENT_DEPT_ID IN (:deptIdIn)}
 #ETC{ AND event.HOSPITAL_AREA_ID IN (:hospitalAreaList) }
  #EQUALS{:status; 98175; AND UNPLANNED_DIFFICULT_DISCUSSION = '98175' ; }
 #EQUALS{:status; 98176; AND UNPLANNED_DIFFICULT_DISCUSSION = '98176' ; }'"
```
...
- 指标概念：[[concepts/HXZD-006-001非计划再次住院_手术患者疑难病例讨论完成率]]
- 血缘解析：[[entities/HXZD-006-001_非计划再次住院_手术患者疑难病例讨论完成率_血缘说明.md]]
...
<!-- entity: HXZD-006-001 | code: HXZD-006-001 | system: 疑难病例讨论制度 | dim: 逻辑判定类 -->