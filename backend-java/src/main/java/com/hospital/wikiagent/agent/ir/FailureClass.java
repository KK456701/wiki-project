...
public enum FailureClass {
    ...
    private static final Map<String, FailureClass> CODES = Map.ofEntries(
            ...
            Map.entry("INTENT_AMBIGUOUS", USER_CLARIFICATION_REQUIRED),
            Map.entry("INDICATOR_AMBIGUOUS", USER_CLARIFICATION_REQUIRED),
            Map.entry("INDICATOR_NOT_FOUND", USER_CLARIFICATION_REQUIRED),
            ...
            Map.entry("STAT_PERIOD_EXCEEDS_ONE_MONTH", USER_CLARIFICATION_REQUIRED),
            Map.entry("CALIBER_PROFILE_NOT_FOUND", USER_CLARIFICATION_REQUIRED),
            Map.entry("CALIBER_PROFILE_AMBIGUOUS", USER_CLARIFICATION_REQUIRED),
            Map.entry("CALIBER_PROFILE_MISSING", USER_CLARIFICATION_REQUIRED),
            Map.entry("DATABASE_ACCESS_CONFLICT", DATABASE_ERROR),
            Map.entry("DATABASE_UNAVAILABLE", DATABASE_ERROR),
            Map.entry("DB_SOURCE_RETIRED", DATABASE_ERROR),
            Map.entry("DB_SOURCE_ROLE_INVALID", DATABASE_ERROR),
            Map.entry("DUAL_DATABASE_CONFIG_INCOMPLETE", DATABASE_ERROR),
            Map.entry("TRIAL_RUN_FAILED", DATABASE_ERROR),
            Map.entry("BUSINESS_DATABASE_OVERVIEW_FAILED", DATABASE_ERROR),
            Map.entry("REAL_DATABASE_OVERVIEW_FAILED", DATABASE_ERROR),
            Map.entry("SOURCE_EXTRACTION_FAILED", TOOL_ERROR),
            Map.entry("SOURCE_EXTRACTION_MCP_FAILED", TOOL_ERROR),
            Map.entry("EXTRACTION_GATEWAY_UNAVAILABLE", TOOL_ERROR),
            Map.entry("DUAL_DATABASE_SCHEMA_INCOMPATIBLE", TOOL_ERROR),
            Map.entry("DUAL_DIAGNOSIS_REPORT_PERSIST_FAILED", TOOL_ERROR),
            Map.entry("DUAL_RUN_PERSIST_FAILED", TOOL_ERROR),
            Map.entry("DETAIL_COMPARISON_CONTRACT_MISSING", TOOL_ERROR),
            Map.entry("DUAL_DETAIL_QUERY_FAILED", TOOL_ERROR),
            ...
            Map.entry("EVIDENCE_CALIBER_MISMATCH", EVIDENCE_CONFLICT),
            Map.entry("CALIBER_PROFILE_CHAIN_MISMATCH", EVIDENCE_CONFLICT),
